...
export default function PrivacyPolicy() {
  ...
  const zh = locale === 'zh';
  const paragraphs = zh ? [
    'Chromaflow2 无需注册或登录。最近 50 条练习记录和语言偏好仅保存在当前浏览器的本地存储中，不会发送到应用后端。',
    ...
    'Chromaflow2 requires no account. The latest 50 practice records and your language preference are stored in this browser and are not sent to an application backend.',
